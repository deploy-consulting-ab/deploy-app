...
export const PROTECTED_ROUTES = [
    ...
    { path : USERS_ROUTE, permission : VIEW_ADMIN_PERMISSION }, // TO CHANGE TO VIEW_USERS_PERMISSION
    { path : PROFILES_ROUTE, permission : VIEW_ADMIN_PERMISSION }, // TO CHANGE TO VIEW_PROFILES_PERMISSION
    { path : PERMISSION_SETS_ROUTE, permission : VIEW_ADMIN_PERMISSION }, // TO CHANGE TO VIEW_PERMISSION_SETS_PERMISSION
    { path : PERMISSIONS_ROUTE, permission : VIEW_ADMIN_PERMISSION }, // TO CHANGE TO VIEW_PERMISSIONS_PERMISSION
