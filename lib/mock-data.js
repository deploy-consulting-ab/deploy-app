...
export function generateSampleTimeEntries() {
    ...
    for (let weekOffset = 0; weekOffset < 4; weekOffset++) {
        ...
        entries[weekKey] = {
            'proj-001': [8, 8, 8, 8, 8, 0, 0],
            'internal-001': [0, 0, 0, 0, 0, 0, 0],
        };
        ...
        if (weekOffset === 0) {
            ...
            entries[weekKey] = {
                'proj-001': [8, 8, 4, 0, 0, 0, 0].map((h, i) => i <= currentDayIndex ? h : 0),
                'internal-001': [0, 0, 4, 0, 0, 0, 0].map((h, i) => i <= currentDayIndex ? h : 0),
            };
        }
    }
