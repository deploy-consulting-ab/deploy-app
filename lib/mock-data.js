...
export function generateSampleTimeEntries() {
    ...
    for (let weekOffset = 0; weekOffset < 4; weekOffset++) {
        ...
        entries[weekKey] = {
            'a0dKB000003jBL9YAM': [8, 8, 8, 8, 8, 0, 0],
            'a0dKB000003jBL8YAM': [0, 0, 0, 0, 0, 0, 0],
        };
        ...
        if (weekOffset === 0) {
            ...
            entries[weekKey] = {
                'a0dKB000003jBL9YAM': [8, 8, 4, 0, 0, 0, 0].map((h, i) => i <= currentDayIndex ? h : 0),
                'a0dKB000003jBL8YAM': [0, 0, 4, 0, 0, 0, 0].map((h, i) => i <= currentDayIndex ? h : 0),
            };
        }
    }
