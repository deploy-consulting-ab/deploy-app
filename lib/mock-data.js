...
export function generateSampleTimeEntries() {
    ...
    for (let weekOffset = 0; weekOffset < 4; weekOffset++) {
        ...
        if (weekOffset === 0) {
            ...
            entries[weekKey] = {
                '5da89f33-0e68-4855-8340-b30800fd8de0': [8, 8, 4, 0, 0, 0, 0].map((h, i) => i <= currentDayIndex ? h : 0),
                '5da89f33-0e68-4855-8340-b30800fd8de1': [0, 0, 4, 0, 0, 0, 0].map((h, i) => i <= currentDayIndex ? h : 0),
            };
        }
    }
